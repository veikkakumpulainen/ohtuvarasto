...
def testaa_huonot_konstruktorit():
...
def testaa_yli_lisaaminen(mehua, olutta):
    print(f"Olutvarasto: {olutta}")
...
def testaa_yli_ottaminen(mehua, olutta):
    print(f"Olutvarasto: {olutta}")
...
def testaa_virhetilanteet(mehua, olutta):
    testaa_huonot_konstruktorit()
    testaa_yli_lisaaminen(mehua, olutta)
    testaa_yli_ottaminen(mehua, olutta)
